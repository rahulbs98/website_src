...
5. **Set album details**: 
   - Enter album name (e.g., "Tokyo 2024") — will be normalized to "tokyo-2024"
...
│           └── eiffel-tower.jpg
└── data/
    ├── albums.meta.json    ← Updated by app (metadata)
    └── albums.json         ← Generated by npm run albums (for website)
```
